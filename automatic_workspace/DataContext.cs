...
namespace automatic_workspace
{
    ...
    {
        public DbSet<OperatorWorkspace>  OperatorWorkspace { get; set; }
        ...
        {
            optionsBuilder
                .UseNpgsql(Properties.Settings.Default.dataString)
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<OperatorWorkspace>()
                .HasIndex("Login")
                .HasName("postgres.public.operator_workspace.operator_workspace_login_uindex") 
                .IsUnique();
